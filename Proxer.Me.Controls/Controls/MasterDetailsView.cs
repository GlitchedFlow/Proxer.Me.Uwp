...
{
	/// <summary>
	/// Represents a control that displays data items in a vertical stack, with accompanying selected
	/// data item in more detail. Supports separate commandbars for master and details views, which
	/// move to the bottom in the case of mobile devices for easier access
	/// </summary>
	...
	public sealed class MasterDetailsView : ListView, IBindable
	{
		...
		#endregion Control Contract Properties
